...
class FCN_model_Fourier_Feature_CNN(nn.Module):
    def __init__(self,input_space,output_space,N_features,sigma_1=1,sigma_2=15):
        ...
        self.pool1=nn.MaxPool1d(kernel_size = 3, stride = 2, padding = 1)# stride=2   (720-3)/2 + 1 = 360 *3
        ...
        self.fc_combo1=nn.Linear(in_features=6120,out_features=6144,device=GPU)
        self.fc_combo2=nn.Linear(in_features=6144,out_features=6144,device=GPU)
        self.fc_combo3=nn.Linear(in_features=6144,out_features=6144,device=GPU)
        self.fc_combo4=nn.Linear(in_features=6144,out_features=6144,device=GPU)
        self.fc_combo5=nn.Linear(in_features=6144,out_features=6144,device=GPU)
        self.fc_combo6=nn.Linear(in_features=6144,out_features=6144,device=GPU)


        
        self.out=nn.Linear(in_features=6144,out_features=output_space.dim,device=GPU)
